  ...
  return (
    <label className="flex flex-col gap-1">
      ...
      <select
        ...
        className="w-44 rounded-lg border border-[#e5e0d9] bg-white px-2 py-1.5 text-sm text-[#0d0d0d] shadow-sm transition-colors focus:border-[#e5341a] focus:outline-none focus:ring-1 focus:ring-[#e5341a] disabled:opacity-50"
      >
